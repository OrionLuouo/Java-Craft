package OrionLuouo.Craft.system.reflect;
...
public class Classes {
    /**
     * Get the classes in path var:pack.
     */
    public static Set<Class<?>> getClasses(String pack) {
        return getClasses(pack, false);
    }

    /**
     * Get all the classes in var:pack.
     * Include the children packages.
     */
    public static Set<Class<?>> getAllClasses(String pack) {
